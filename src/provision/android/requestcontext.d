...
@AndroidClassInfo(Library.LIBANDROIDAPPMUSIC, 392) class RequestContext : AndroidClass {
    ...
    mixin implementMethod!(StoreErrorCondition function(RequestContext,
            ref const(shared_ptr!RequestContextConfig)), "initialize",
            "_ZN17storeservicescore14RequestContext4initERKNSt6__ndk110shared_ptrINS_20RequestContextConfigEEE");
    mixin implementMethod!(long function(RequestContext), "preferredAccountDSID",
            "_ZN17storeservicescore14RequestContext20preferredAccountDSIDEv");

    mixin implementMethod!(StoreErrorCondition function( /+RequestContext, +/ string), "getAuthHeader", "_ZN17storeservicescore14RequestContext13getAuthHeaderERKNSt6__ndk112basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEE");
